...
Nova.booting(function (Vue, router) {
    Vue.component('nova-timenow', __webpack_require__(2));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment_timezone__ = __webpack_require__(135);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        updateCurrentTime: function updateCurrentTime() {
            var _card = this.card,
                locale = _card.locale,
                timeFormat = _card.timeFormat,
                dateFormat = _card.dateFormat;


            var datetime = __WEBPACK_IMPORTED_MODULE_0_moment_timezone___default()().locale(locale).tz(this.currentTimezone);
          ...
          "select",
          {
            ...
            on: {
              change: function($event) {
                ...
                _vm.currentTimezone = $event.target.multiple
                  ? $$selectedVal
                  : $$selectedVal[0]
              }
            }
...
(function (root, factory) {
	...
	if (typeof module === 'object' && module.exports) {
		module.exports = factory(__webpack_require__(11)); // Node
	} else if (true) {
